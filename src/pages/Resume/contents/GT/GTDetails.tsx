...
export const GTDetails: FC = () => (
  <>
    <Typography variant="body2" marginTop={5} marginBottom={2}>
      Developed backend servers to deliver RESTful APIs for mobile applications
      using Java/Kotlin with Spring Boot or TypeScript with Node.js with clients
      of restaurant, shopping malls and retails.
    </Typography>
    ...
    <Typography variant="body2" marginBottom={2}>
      Prepared API documentation for frontend applications and third parties to
      integrate.
    </Typography>
